...
JOBS=(attra-blog-ai attra-news-ingestion attra-hero-preprocess attra-cleanup-tracking attra-embeddings-sync attra-feed-openai attra-indexnow-sync attra-crm-retorno)
