...
export const CONFIANCA_PAGES: ConfiancaPage[] = [
	{
		...
		sections: [
			...
			{ heading: `${anosDeMercado()} anos de mercado`, content: `A Attra Veículos opera desde ${ANO_FUNDACAO} em Uberlândia, Minas Gerais. São ${anosDeMercado()} anos construindo reputação com transações transparentes e clientes satisfeitos em todo o Brasil.` },
