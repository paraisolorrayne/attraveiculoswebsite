...
export const SEO_BRANDS: SEOBrand[] = [
	...
	},
	{
		...
		country: 'Itália',
		tagline: 'O superesportivo como declaração',
		description: 'A Lamborghini nasceu de uma discordância: Ferruccio Lamborghini achava que conseguia fazer melhor que a Ferrari. Desde 1963 a marca de Sant\'Agata Bolognese entrega motores atmosféricos de doze e dez cilindros, linhas anguladas e presença que não passa despercebida — o oposto da discrição.',
		metaTitle: 'Comprar Lamborghini no Brasil | Huracán, Urus e Gallardo',
		metaDescription: 'Lamborghini à venda no Brasil com procedência verificada. Huracán, Urus, Gallardo e Aventador. Curadoria, laudo cautelar e entrega nacional. Attra Veículos.',
		keywords: ['comprar lamborghini brasil', 'lamborghini a venda', 'lamborghini seminovo', 'onde comprar lamborghini', 'lamborghini preço brasil'],
		highlights: [
			'Motores atmosféricos V10 e V12 — som que turbo nenhum reproduz',
			'Produção limitada por modelo — escassez sustenta valor',
			'Tração integral em toda a linha moderna',
			'Mercado brasileiro restrito: procedência vale mais que em qualquer outra marca',
		],
		models: [
			{
				slug: 'urus',
				...
				tagline: 'O SUV que corre como superesportivo',
				description: 'O Urus resolveu a equação que a Lamborghini evitava: espaço e uso diário sem abrir mão de performance. V8 biturbo de 4.0 litros, tração integral e postura de SUV com dinâmica de esportivo — é o modelo que mais ampliou a base de proprietários da marca.',
				metaTitle: 'Lamborghini Urus à Venda no Brasil | SUV Superesportivo',
				metaDescription: 'Comprar Lamborghini Urus no Brasil com procedência verificada. SUV de 650 cv, specs, fotos e financiamento. Entrega nacional — Attra Veículos.',
				keywords: ['lamborghini urus preço brasil', 'comprar lamborghini urus', 'urus seminovo', 'suv lamborghini'],
				category: 'suv',
				highlights: ['V8 4.0 biturbo', 'Tração integral com torque vetorial', 'Uso diário real, com porta-malas utilizável', 'O Lamborghini de maior volume no Brasil'],
			},
			{
				slug: 'gallardo',
				name: 'Gallardo',
				fullName: 'Lamborghini Gallardo',
				tagline: 'O V10 que popularizou a marca',
				description: 'O Gallardo foi o Lamborghini mais produzido da história até ser sucedido pelo Huracán, e é hoje a porta de entrada para o V10 atmosférico da marca. Motor central, tração integral e uma mecânica que envelheceu bem — desde que o histórico de manutenção acompanhe.',
				metaTitle: 'Lamborghini Gallardo à Venda no Brasil | V10 Atmosférico',
				metaDescription: 'Comprar Lamborghini Gallardo no Brasil. V10 atmosférico com procedência verificada e histórico de manutenção auditado. Attra Veículos.',
				keywords: ['lamborghini gallardo preço', 'comprar gallardo', 'gallardo lp560', 'lamborghini v10'],
				category: 'supercar',
				highlights: ['V10 5.2 atmosférico', 'Motor central traseiro', 'Tração integral', 'Manutenção documentada é o fator decisivo de valor'],
			},
		],
	},
	{
		...
		displayName: 'Bentley',
		country: 'Reino Unido',
		tagline: 'Potência britânica sem alarde',
		description: 'A Bentley entrega o que poucas marcas conseguem reunir: motor W12 ou V8 de torque abundante, acabamento artesanal em couro e madeira, e uma condução que isola o mundo lá fora. É o carro de quem quer desempenho de superesportivo dentro de um salão silencioso.',
		metaTitle: 'Comprar Bentley no Brasil | Continental GT e Bentayga',
		metaDescription: 'Bentley à venda no Brasil com procedência verificada. Continental GT e Bentayga com curadoria, laudo cautelar e entrega nacional. Attra Veículos.',
		keywords: ['comprar bentley brasil', 'bentley a venda', 'bentley usada', 'bentley seminovo', 'onde comprar bentley'],
		highlights: [
			'Acabamento artesanal — couro e marcenaria feitos à mão em Crewe',
			'Motores W12 e V8 com torque disponível desde baixa rotação',
			'Isolamento acústico de referência no segmento',
			'Manutenção exige rede especializada: histórico documentado é essencial',
		],
		models: [
			{
				slug: 'continental-gt',
				...
				tagline: 'O grand tourer que definiu a categoria',
				description: 'O Continental GT é o carro que reposicionou a Bentley no século XXI: cupê de duas portas capaz de cruzar países em alta velocidade com dois ocupantes confortáveis. Motor W12 ou V8, tração integral e uma cabine que privilegia material sobre tela.',
				metaTitle: 'Bentley Continental GT à Venda no Brasil | Grand Tourer',
				metaDescription: 'Comprar Bentley Continental GT no Brasil. Grand tourer W12 ou V8 com procedência verificada e entrega nacional. Attra Veículos.',
				keywords: ['bentley continental gt preço', 'comprar continental gt', 'bentley continental usado', 'grand tourer bentley'],
				category: 'gt',
				highlights: ['Motor W12 6.0 ou V8 4.0 biturbo', 'Tração integral', 'Cabine artesanal em couro e madeira', 'Conforto de sedã com desempenho de esportivo'],
			},
			{
				slug: 'bentayga',
				name: 'Bentayga',
				fullName: 'Bentley Bentayga',
				tagline: 'O SUV do segmento mais alto',
				description: 'O Bentayga levou o padrão Bentley para o formato que o mercado passou a exigir. Altura de comando, espaço para quatro adultos e o mesmo acabamento artesanal do Continental, com desempenho que nenhum SUV convencional acompanha.',
				metaTitle: 'Bentley Bentayga à Venda no Brasil | SUV de Luxo',
				metaDescription: 'Comprar Bentley Bentayga no Brasil. SUV de luxo com procedência verificada, specs e fotos. Entrega nacional — Attra Veículos.',
				keywords: ['bentley bentayga preço brasil', 'comprar bentayga', 'suv bentley', 'bentayga usado'],
				category: 'suv',
				highlights: ['Motor W12 ou V8 biturbo', 'Suspensão pneumática adaptativa', 'Quatro adultos com espaço real', 'Acabamento artesanal de Crewe'],
			},
		],
	},
]
